...
FILTER_CONFIGS = {
    'F210M': {
        'pixscale': 0.03068,  # from spaceKLIP database
        'PA_offset': 0,
        'psf_dir': f'../Data/F210M/psf_models_blurred_hp_npx_5',
        'psf_dict': {
...
PLANET_CONFIGS = {
    'b': {'sep': 544.055, 'pa': 31.09, 'guessflux': 1500000},
}
...
def run_mcmc_fit(data_frame: np.ndarray, fm_frame: np.ndarray, 
                 ...
                 pa_offset: float = 0,
                 fittingSize=13) -> fitpsf.FMAstrometry:
...
def perform_klip_fm(database, 
    ...
    fm.klip_dataset(dataset,
                    ...
                    annuli=[[0, guess_params['sep']-10],
                            [guess_params['sep']-10, guess_params['sep']+15],
                            [guess_params['sep']+15, 1000]],                            
...
if __name__ == "__main__":
    import spaceKLIP
    data_root = '../Data/F210M_LIKELY_Th8'
    pid = 4758
    filter_name = 'F210M'
